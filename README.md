...
<p align="center">
  <img src="https://f.top4top.io/p_36860l0yx1.png" alt="Thumbnail" />
</p>
...
await sock.sendMessage(jid, { 
    eventMessage: { 
        ...
        joinLink: "https://call.whatsapp.com/video/ClestialXKalzz", 
...
await sock.sendMessage(jid, {
    interactiveMessage: {
        header: "Hello World",
        title: "Hello World",
        footer: "telegram: @ClestialXKalzz ",
        buttons: [
            {
                name: "cta_copy",
        ...
        nativeFlowMessage: {        
            messageParamsJson: JSON.stringify({          
                ...
                tap_target_configuration: {            
                    ...
                    canonical_url: "https://t.me/ClestialXKalzz",            
...
await sock.sendMessage(jid, {
    interactiveMessage: {
        ...
        externalAdReply: {
            ...
            mediaUrl: " X ",
            sourceUrl: "https://t.me/ClestialXKalzz",
        ...
        buttons: [
            {
                ...
                buttonParamsJson: JSON.stringify({
                    ...
                    url: "https://t.me/ClestialXKalzz",
                    merchant_url: "https://t.me/ClestialXKalzz"
                })
            }
        ]
    }
